...
namespace Gadgeteer.Modules.DevhammerEnterprises
{
    ...
    public class StarBoard : GTM.Module
    {
        ...
        public StarBoard(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the StarBoard is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="StarBoard"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="StarBoard"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="StarBoard"/></param>
        public delegate void ButtonEventHandler(StarBoard sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="StarBoard"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="StarBoard"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="StarBoard"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(StarBoard sender, ButtonState buttonState)
        {
